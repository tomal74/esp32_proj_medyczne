...
#define ACTION_CLEAR_CALIB_BNO055_TYPE 12
#define ACTION_RUN_CALIB_BNO055_TYPE 13
#define ACTION_SET_CALIB_BNO055_TYPE 14
#define ACTION_SET_RESTART 15
#define ACTION_SET_UPGRADE    16

int action;

// Radiobutton output
char output_driver_tab[6][22] = {"None", "Cytron MD30 + SWM", "IBT_2 +SWM", "IBT_2 +PWM Valve", "IBT_2 +Danfoss Valve", "Bullet SERVO"};
